...
# -*- coding: utf-8 -*-
"""
modified additionally on Fri Sep 27 22:49:18 2019
...
image_type = str(raw_input("What is your image first subject query?  (Examples: pikachu, eevee) : "))
print(image_type)
query = image_type
image_type1 = str(raw_input("What is your image second subject query?  (Examples: psyduck, squirtle) : "))
query1 = image_type1
...
for img in images:
    ...
    imgPic=mpimg.imread("images/" + image_type + "_"+ str(cntr) +".jpeg")
    imgplot = plt.imshow(imgPic)
...
time.sleep(2)
print("Edit the pulled images")
time.sleep(2)
subprocess.Popen(['xdg-open', 'images'])
time.sleep(3)
...
#print files
#imgSelection="x"
#while imgSelection not in {'edit','delete'}:
#    imgSelection = str(raw_input("Would you like to edit the image folder or delete your gathered images? enter 'edit' or 'delete' : "))
#
#if imgSelection == "edit":
    #os.system('cd /images')
#    subprocess.Popen(['xdg-open', 'images'])
    #cmd = 'ls -la /images/*.jpeg'
    #os.system(cmd)
#else:
#    for file in files:
